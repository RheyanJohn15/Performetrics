  ...
  logoutBtn.onclick = function() {
   window.location.href="{{route('login.index')}}";
        ...
        <main class="h-full overflow-y-auto">
          ...
          @php
        $teachers = App\Models\EvaluationResult::where('evaluator_type', 'Student')
    ...
    ->pluck('teacher_id');
          ...
          $teach= App\Models\Teacher::where('id', $teacher)->first();
            ...
            $scores= App\Models\EvaluationResult::where('teacher_id', $teacher)->where('evaluator_type', 'Student')->where('evaluator_id', session('user_id'))->get();
            $num=1;
            @endphp
            <div class="section">
                <details>
