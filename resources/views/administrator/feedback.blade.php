...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  <head>
    ...
    <title>Perfometrics Settings</title>
    <link
        ...
        <div class="py-4 text-gray-500 dark:text-gray-400">
          ...
          <ul>
            <li class="relative px-6 py-3">
              ...
              <a
                class="inline-flex items-center  w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:text-gray-100 dark:hover:text-gray-200"
                href="{{route('settings')}}"
              >
                <svg
                  class="w-5 h-5"
            ...
            <li class="relative px-6 py-3">
              ...
              ></span>
                <a
                  class="inline-flex items-center text-gray-800 w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                  href="{{route('feedback')}}"
                >
                  <svg
                    class="w-5 h-5"
      ...
      <div class="flex flex-col flex-1 w-full">
        ...
        <p class="text-gray-600 dark:text-gray-400">
         {{$message->message}}
          ...
          @else
            <p class="text-sm text-center font-semibold text-gray-400 dark:text-gray-800">
                NO FEEDBACK AT THE MOMENT
              </p>
              <p class=" text-center font-semibold text-gray-400 dark:text-gray-800">
