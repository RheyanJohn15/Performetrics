...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  <head>
    ...
    <title>View Data-Perfometrics Dashboard</title>
    <link
...
@php
   ...
   if($totalScore1===0 || $totalRows1===0){
    ...
    $totalAverage1= $totalScore1/$totalRows1;
   }

   if($totalScore2===0 || $totalRows2===0){
    $totalAverage2=0;
   }else{
    $totalAverage2= $totalScore2/$totalRows2;
   }
   ...
   if($totalAverage1===0 || $totalAverage2===0){
    ...
    $total=$totalAverage1 + $totalAverage2;
    $finalAverage= $total/2;
    $bar= 49.5*$finalAverage;
    $starinitial= 21.25*$finalAverage;
    $star= 85-$starinitial;
   }
...
@endphp
  ...
  <tr onclick="openData{{$t}}()" id="tr{{$t}}" class="text-gray-700 dark:text-gray-400">
 <td class="px-4 py-3">
 <div class="flex items-center text-sm">
 <div class="relative hidden w-8 h-8 mr-3 rounded-full md:block">
 <img class="object-cover w-full h-full rounded-full" src="https://www.dovercourt.org/wp-content/uploads/2019/11/610-6104451_image-placeholder-png-user-profile-placeholder-image-png.jpg" alt="" loading="lazy"/>
 <div class="absolute inset-0 rounded-full shadow-inner" aria-hidden="true"></div></div>
 <div><p class="font-semibold">{{$teacher->teacher_first_name. " ". substr($teacher->teacher_middle_name, 0, 1). ". ". $teacher->teacher_last_name. " ". $teacher->teacher_suffix}}</p>
 <p class="text-xs text-gray-600 dark:text-gray-400"><div class="cover"><div class="bar_graph" style= "width: {{$bar}}px"></div></div><p class="text-xs text-gray-600 dark:text-gray-400">Over all Rating: {{number_format($finalAverage, 2)}}</p></p></div></div></td>
 <td class="px-4 py-3">
    <div class="relative">
        <div class="absolute inset-0 z-10" style="width: 85px; background-color:transparent;">
        <div id="cover{{$t}}" style="float: right; width:{{$star}}px; background-color:white; height:100%;"></div></div>
        <i class="fa-solid fa-star" style="color: #7e3af2; z-index: 20;"></i>
        <i style="color: #7e3af2; z-index: 20;" class="fa-solid fa-star"></i>
        <i style="color: #7e3af2; z-index: 20;" class="fa-solid fa-star"></i>
        <i style="color: #7e3af2; z-index: 20;" class="fa-solid fa-star"></i>
    </div>
 ...
 <script>
  ...
  window.location.href= "{{route('result')}}?teacher_id="+teacher_id;
}

    (function(t) {
        const hoverElement = document.getElementById('tr' + t);
        const cover = document.getElementById('cover' + t);

        hoverElement.addEventListener('mouseenter', function() {
            cover.style.backgroundColor = "#e5e7eb";
        });
