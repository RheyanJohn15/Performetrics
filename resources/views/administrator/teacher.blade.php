...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  <head>
    ...
    <title>Teacher Info-Perfometrics Dashboard</title>
    <link
  ...
  <body>
    ...
    if($image->admin_image===1){
        $profilePic2= asset('Users/Admin('. session('user_id'). ").". $image->admin_image_type);
    }else{
...
@endphp
            <div class="flex flex-col md:flex-row h-screen w-screen mt-4">
                ...
                <div class="md:w-1/2 h-full mr-4 px-4 py-3 bg-white rounded-lg shadow-md dark:bg-gray-800">
                  ...
                  <form action="{{route('alterTeacher')}}" method="post" class="border border-solid-gray-800">
                 ...
                 @method('post')
                        <div class="flex-1 h-full px-4 py-3">
                            <label class="block text-sm">
                              ...
                              <label style="display: none" id="dropdown" class="block mt-4 text-sm">
                                <span class="text-gray-700 dark:text-gray-400">Suffix</span>
                                <select name="suffixTeacher" class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray">
                  ...
                  <div class="ml-4 mb-4 w-full">
                    <input type="hidden" name="hiddenTeacherId" value="{{$teacher_id}}" id="">
