...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  <head>
    ...
    <title>Assign Teachers-Perfometrics Dashboard</title>
    <link
  ...
  logoutBtn.onclick = function() {
    window.location.href= "{{route('login.index')}}";
        ...
        <main class="h-full pb-16 overflow-y-auto">
          ...
          >
            Select Strand to see assigned Teacher (Current Semester: {{$CurrentSem->admin_sem}})
          </h2>
            <div class="w-full mb-8 overflow-hidden rounded-lg shadow-xs">
                ...
                <div class="w-full overflow-x-auto">
                  <table class="w-full whitespace-no-wrap">
                    ...
                    <tr onclick="EditOpenG11{{$g11}}()" class="text-gray-700 dark:text-gray-400 ">
            ...
            <div class="w-full mb-8 overflow-hidden rounded-lg shadow-xs">
                <div class="w-full overflow-x-auto">
                  <table class="w-full whitespace-no-wrap">
                    ...
                    <tr onclick="EditOpenG12{{$g12}}()" class="text-gray-700 dark:text-gray-400">
                      <td class="px-4 py-3 text-sm">
                        {{$strands->strand_name}}
                      </td>
                      <td class="px-4 py-3 text-sm">
