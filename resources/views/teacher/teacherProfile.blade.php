...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  <head>
    ...
    <title>Teacher Profile- {{session('user_name')}}</title>
    <link
          ...
          <div class="container px-6 mx-auto grid h-full">
            ...
            <div class="flex flex-col md:flex-row h-screen w-screen mt-4">
                ...
                <div class="md:w-1/2 h-full mr-4 px-4 py-3 bg-white rounded-lg shadow-md dark:bg-gray-800">
                  ...
                  <form style="display: block" action="{{route('updatePersonalTeacher')}}" id="personalForm" method="POST" class="border border-solid-gray-800">
                    @csrf
                    @method('post')
                  ...
                  <form action="{{route('changePassTeacher')}}" style="display: none" id="changePassword" method="POST" class="border border-solid-gray-800">
                    @csrf
                    @method('post')
                    <div class="flex h-full w-full">
...
<img id="preview" class="placeholder" capture="user" accept="image/*" src="{{$profilePic}}"
 alt="alt">
    ...
    <form method="post" action="{{route('updatePictureTeacher')}}" enctype="multipart/form-data">
        @csrf
       @method('post')
