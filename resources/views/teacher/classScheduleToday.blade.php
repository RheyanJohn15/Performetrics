...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
      ...
      >
        ...
        {{session('user_name')}}
          ...
          <ul>
            ...
            ></span>
              <a
                class="inline-flex items-center text-gray-800 w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-200"
      ...
      >
        ...
        {{session('user_name')}}
          ...
          <ul>
            ...
            ></span>
              <a
                class="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-200"
                href="{{route('teacherClassScheduleToday')}}"
              >
                <svg
                  class="w-5 h-5"
  ...
  logoutBtn.onclick = function() {
   ...
   $sections= App\Models\ClassSchedule::where('sched_teacher', session('user_id'))->where('sched_day', date('l'))->get();
   ...
   @endphp
        <main class="h-full overflow-y-auto">
          ...
          >
            Class Schedule of Ms/Mr. {{session('user_name')}}
            </h2>
            <div class="w-full mb-8 overflow-hidden rounded-lg shadow-xs">
              <div class="w-full overflow-x-auto">
                <table class="w-full whitespace-no-wrap">
                  ...
                  @if($section->sched_room!= 13 && $section->sched_subject!=204)
                  @php 
                  ...
                  $class= App\Models\Section::where('id', $section->sched_class_name)->first();
                  $className= $class->year_level. "-". $class->section. " ". App\Models\Strand::where('id', $class->strand_id)->first()->strand_name;
                   @endphp
