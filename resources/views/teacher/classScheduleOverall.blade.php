...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  ...
  logoutBtn.onclick = function() {
   ...
   $sections= App\Models\ClassSchedule::where('sched_teacher', session('user_id'))->get();
              ...
              <div class="w-full overflow-x-auto">
                <table class="w-full whitespace-no-wrap">
                 ...
                 $subject= App\Models\AssignedSubject::where('id', $section->sched_subject)->first();
                  ...
                  $className= $class->year_level. " - ".$class->section. "  ". App\Models\Strand::where('id', $class->strand_id)->first()->strand_shortcut;
                   @endphp
